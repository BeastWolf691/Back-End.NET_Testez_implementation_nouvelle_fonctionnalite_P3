...
namespace P3AddNewFunctionalityDotNetCore.Tests
{
        ...
        {
            private DbContextOptions<P3Referential> CreateOptions() =>
                new DbContextOptionsBuilder<P3Referential>()
            ...
            private ProductViewModel CreateTestProductViewModel() =>
            ...
            private ProductController CreateController(P3Referential context)
            {
                ...
                return new ProductController(productService, null);
            }
            ...
            public void AddProduct_ShouldBeVisibleInClientList()
            {
                ...
                using var context = new P3Referential(options, config.Object);

                var controller = CreateController(context);
                var productViewModel = CreateTestProductViewModel();
